...
let HelixEventSubApi = class HelixEventSubApi extends BaseApi_1.BaseApi {
    ...
    async subscribeToChannelAutomaticRewardRedemptionAddEvents(broadcaster, transport) {
        return await this.createSubscription('channel.channel_points_automatic_reward_redemption.add', '1', (0, eventSub_external_1.createEventSubBroadcasterCondition)(broadcaster), transport, broadcaster, ['channel:read:redemptions', 'channel:manage:redemptions']);
    }
    /**
    ...
    async subscribeToChannelChatClearEvents(broadcaster, transport) {
        const broadcasterId = (0, common_1.extractUserId)(broadcaster);
        return await this.createSubscription('channel.chat.clear', '1', (0, eventSub_external_1.createEventSubUserCondition)(broadcasterId, this._getUserContextIdWithDefault(broadcasterId)), transport, broadcaster, ['user:read:chat'], true);
    }
    /**
    ...
    async subscribeToChannelChatClearUserMessagesEvents(broadcaster, transport) {
        const broadcasterId = (0, common_1.extractUserId)(broadcaster);
        return await this.createSubscription('channel.chat.clear_user_messages', '1', (0, eventSub_external_1.createEventSubUserCondition)(broadcasterId, this._getUserContextIdWithDefault(broadcasterId)), transport, broadcaster, ['user:read:chat'], true);
    }
    /**
    ...
    async subscribeToChannelChatMessageDeleteEvents(broadcaster, transport) {
        const broadcasterId = (0, common_1.extractUserId)(broadcaster);
        return await this.createSubscription('channel.chat.message_delete', '1', (0, eventSub_external_1.createEventSubUserCondition)(broadcasterId, this._getUserContextIdWithDefault(broadcasterId)), transport, broadcaster, ['user:read:chat'], true);
    }
    /**
    ...
    async subscribeToChannelChatNotificationEvents(broadcaster, transport) {
        const broadcasterId = (0, common_1.extractUserId)(broadcaster);
        return await this.createSubscription('channel.chat.notification', '1', (0, eventSub_external_1.createEventSubUserCondition)(broadcasterId, this._getUserContextIdWithDefault(broadcasterId)), transport, broadcaster, ['user:read:chat'], true);
    }
    /**
    ...
    async subscribeToChannelChatMessageEvents(broadcaster, transport) {
        const broadcasterId = (0, common_1.extractUserId)(broadcaster);
        return await this.createSubscription('channel.chat.message', '1', (0, eventSub_external_1.createEventSubUserCondition)(broadcasterId, this._getUserContextIdWithDefault(broadcasterId)), transport, broadcaster, ['user:read:chat'], true);
    }
    /**
    ...
    async subscribeToChannelUnbanRequestCreateEvents(broadcaster, transport) {
        const broadcasterId = (0, common_1.extractUserId)(broadcaster);
        return await this.createSubscription('channel.unban_request.create', '1', (0, eventSub_external_1.createEventSubModeratorCondition)(broadcasterId, this._getUserContextIdWithDefault(broadcasterId)), transport, broadcaster, ['moderator:read:unban_requests', 'moderator:manage:unban_requests'], true);
    }
    /**
    ...
    async subscribeToChannelUnbanRequestResolveEvents(broadcaster, transport) {
        const broadcasterId = (0, common_1.extractUserId)(broadcaster);
        return await this.createSubscription('channel.unban_request.resolve', '1', (0, eventSub_external_1.createEventSubModeratorCondition)(broadcasterId, this._getUserContextIdWithDefault(broadcasterId)), transport, broadcaster, ['moderator:read:unban_requests', 'moderator:manage:unban_requests'], true);
    }
    /**
    ...
    async subscribeToChannelModerateEvents(broadcaster, transport) {
        const broadcasterId = (0, common_1.extractUserId)(broadcaster);
        return await this.createSubscription('channel.moderate', '2', (0, eventSub_external_1.createEventSubModeratorCondition)(broadcasterId, this._getUserContextIdWithDefault(broadcasterId)), transport, broadcaster, [], true);
    }
    /**
    ...
    async subscribeToChannelWarningAcknowledgeEvents(broadcaster, transport) {
        const broadcasterId = (0, common_1.extractUserId)(broadcaster);
        return await this.createSubscription('channel.warning.acknowledge', '1', (0, eventSub_external_1.createEventSubModeratorCondition)(broadcasterId, this._getUserContextIdWithDefault(broadcasterId)), transport, broadcaster, ['moderator:read:warnings', 'moderator:manage:warnings'], true);
    }
    /**
    ...
    async subscribeToChannelWarningSendEvents(broadcaster, transport) {
        const broadcasterId = (0, common_1.extractUserId)(broadcaster);
        return await this.createSubscription('channel.warning.send', '1', (0, eventSub_external_1.createEventSubModeratorCondition)(broadcasterId, this._getUserContextIdWithDefault(broadcasterId)), transport, broadcaster, ['moderator:read:warnings', 'moderator:manage:warnings'], true);
    }
    /**
    ...
    async subscribeToChannelVipAddEvents(broadcaster, transport) {
        return await this.createSubscription('channel.vip.add', '1', (0, eventSub_external_1.createEventSubBroadcasterCondition)(broadcaster), transport, broadcaster, ['channel:read:vips', 'channel:manage:vips']);
    }
    /**
    ...
    async subscribeToChannelVipRemoveEvents(broadcaster, transport) {
        return await this.createSubscription('channel.vip.remove', '1', (0, eventSub_external_1.createEventSubBroadcasterCondition)(broadcaster), transport, broadcaster, ['channel:read:vips', 'channel:manage:vips']);
    }
    /**
    ...
    async subscribeToUserWhisperMessageEvents(user, transport) {
        return await this.createSubscription('user.whisper.message', '1', (0, generic_external_1.createSingleKeyQuery)('user_id', (0, common_1.extractUserId)(user)), transport, user, ['user:read:whispers', 'user:manage:whispers']);
    }
    /**
    ...
    async subscribeToAutoModMessageHoldEvents(broadcaster, transport) {
        const broadcasterId = (0, common_1.extractUserId)(broadcaster);
        return await this.createSubscription('automod.message.hold', '1', (0, eventSub_external_1.createEventSubModeratorCondition)(broadcasterId, this._getUserContextIdWithDefault(broadcasterId)), transport, broadcaster, ['moderator:manage:automod'], true);
    }
    /**
    ...
    async subscribeToAutoModMessageUpdateEvents(broadcaster, transport) {
        const broadcasterId = (0, common_1.extractUserId)(broadcaster);
        return await this.createSubscription('automod.message.update', '1', (0, eventSub_external_1.createEventSubModeratorCondition)(broadcasterId, this._getUserContextIdWithDefault(broadcasterId)), transport, broadcaster, ['moderator:manage:automod'], true);
    }
    /**
    ...
    async subscribeToAutoModSettingsUpdateEvents(broadcaster, transport) {
        const broadcasterId = (0, common_1.extractUserId)(broadcaster);
        return await this.createSubscription('automod.settings.update', '1', (0, eventSub_external_1.createEventSubModeratorCondition)(broadcasterId, this._getUserContextIdWithDefault(broadcasterId)), transport, broadcaster, ['moderator:read:automod_settings'], true);
    }
    /**
    ...
    async subscribeToAutoModTermsUpdateEvents(broadcaster, transport) {
        const broadcasterId = (0, common_1.extractUserId)(broadcaster);
        return await this.createSubscription('automod.terms.update', '1', (0, eventSub_external_1.createEventSubModeratorCondition)(broadcasterId, this._getUserContextIdWithDefault(broadcasterId)), transport, broadcaster, ['moderator:manage:automod'], true);
    }
    /**
    ...
    async subscribeToChannelChatUserMessageHoldEvents(broadcaster, transport) {
        const broadcasterId = (0, common_1.extractUserId)(broadcaster);
        return await this.createSubscription('channel.chat.user_message_hold', '1', (0, eventSub_external_1.createEventSubUserCondition)(broadcasterId, this._getUserContextIdWithDefault(broadcasterId)), transport, broadcaster, ['user:read:chat'], true);
    }
    /**
    ...
    async subscribeToChannelChatUserMessageUpdateEvents(broadcaster, transport) {
        const broadcasterId = (0, common_1.extractUserId)(broadcaster);
        return await this.createSubscription('channel.chat.user_message_update', '1', (0, eventSub_external_1.createEventSubUserCondition)(broadcasterId, this._getUserContextIdWithDefault(broadcasterId)), transport, broadcaster, ['user:read:chat'], true);
    }
    /**
    ...
    async subscribeToChannelSuspiciousUserUpdateEvents(broadcaster, transport) {
        const broadcasterId = (0, common_1.extractUserId)(broadcaster);
        return await this.createSubscription('channel.suspicious_user.update', '1', (0, eventSub_external_1.createEventSubModeratorCondition)(broadcasterId, this._getUserContextIdWithDefault(broadcasterId)), transport, broadcaster, ['moderator:read:suspicious_users'], true);
    }
    /**
    ...
    async subscribeToChannelSuspiciousUserMessageEvents(broadcaster, transport) {
        const broadcasterId = (0, common_1.extractUserId)(broadcaster);
        return await this.createSubscription('channel.suspicious_user.message', '1', (0, eventSub_external_1.createEventSubModeratorCondition)(broadcasterId, this._getUserContextIdWithDefault(broadcasterId)), transport, broadcaster, ['moderator:read:suspicious_users'], true);
    }
    /**

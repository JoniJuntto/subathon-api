...
const HelixUserEmote_1 = require("./HelixUserEmote");
...
let HelixChatApi = class HelixChatApi extends BaseApi_1.BaseApi {
    ...
    async getUserEmotes(user, filter) {
        ...
        const result = await this._client.callApi({
            ...
            query: {
                ...
                ...(0, generic_external_1.createSingleKeyQuery)('broadcasterId', (filter === null || filter === void 0 ? void 0 : filter.broadcaster) ? (0, common_1.extractUserId)(filter.broadcaster) : undefined),
                ...(0, HelixPagination_1.createPaginationQuery)(filter),
            },
        });
        return (0, HelixPaginatedResult_1.createPaginatedResult)(result, HelixUserEmote_1.HelixUserEmote, this._client);
    }
    /**
    ...
    getUserEmotesPaginated(user, broadcaster) {
        ...
        return new HelixPaginatedRequest_1.HelixPaginatedRequest({
            ...
            query: {
                ...(0, generic_external_1.createSingleKeyQuery)('user_id', userId),
                ...(0, generic_external_1.createSingleKeyQuery)('broadcasterId', broadcaster ? (0, common_1.extractUserId)(broadcaster) : undefined),
            },
        }, this._client, (data) => new HelixUserEmote_1.HelixUserEmote(data, this._client));
    }
    /**

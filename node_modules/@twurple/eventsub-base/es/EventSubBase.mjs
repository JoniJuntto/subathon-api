...
import { EventSubAutoModMessageHoldSubscription } from "./subscriptions/EventSubAutoModMessageHoldSubscription.mjs";
import { EventSubAutoModMessageUpdateSubscription } from "./subscriptions/EventSubAutoModMessageUpdateSubscription.mjs";
import { EventSubAutoModSettingsUpdateSubscription } from "./subscriptions/EventSubAutoModSettingsUpdateSubscription.mjs";
import { EventSubAutoModTermsUpdateSubscription } from "./subscriptions/EventSubAutoModTermsUpdateSubscription.mjs";
import { EventSubChannelChatUserMessageHoldSubscription } from "./subscriptions/EventSubChannelChatUserMessageHoldSubscription.mjs";
import { EventSubChannelChatUserMessageUpdateSubscription } from "./subscriptions/EventSubChannelChatUserMessageUpdateSubscription.mjs";
...
import { EventSubChannelChatMessageSubscription } from "./subscriptions/EventSubChannelChatMessageSubscription.mjs";
import { EventSubChannelChatNotificationSubscription } from "./subscriptions/EventSubChannelChatNotificationSubscription.mjs";
import { EventSubChannelChatSettingsUpdateSubscription } from "./subscriptions/EventSubChannelChatSettingsUpdateSubscription.mjs";
...
import { EventSubChannelModerateSubscription } from "./subscriptions/EventSubChannelModerateSubscription.mjs";
...
import { EventSubChannelAutomaticRewardRedemptionAddSubscription } from "./subscriptions/EventSubChannelAutomaticRewardRedemptionAddSubscription.mjs";
...
import { EventSubChannelSuspiciousUserUpdateSubscription } from "./subscriptions/EventSubChannelSuspiciousUserUpdateSubscription.mjs";
import { EventSubChannelSuspiciousUserMessageSubscription } from "./subscriptions/EventSubChannelSuspiciousUserMessageSubscription.mjs";
import { EventSubChannelUnbanRequestCreateSubscription } from "./subscriptions/EventSubChannelUnbanRequestCreateSubscription.mjs";
import { EventSubChannelUnbanRequestResolveSubscription } from "./subscriptions/EventSubChannelUnbanRequestResolveSubscription.mjs";
...
import { EventSubChannelVipAddSubscription } from "./subscriptions/EventSubChannelVipAddSubscription.mjs";
import { EventSubChannelVipRemoveSubscription } from "./subscriptions/EventSubChannelVipRemoveSubscription.mjs";
import { EventSubChannelWarningAcknowledgeSubscription } from "./subscriptions/EventSubChannelWarningAcknowledgeSubscription.mjs";
import { EventSubChannelWarningSendSubscription } from "./subscriptions/EventSubChannelWarningSendSubscription.mjs";
...
import { EventSubUserWhisperMessageSubscription } from "./subscriptions/EventSubUserWhisperMessageSubscription.mjs";
const numberRegex = /^\d+$/;
/**
 * @private
 * @hideProtected
...
let EventSubBase = class EventSubBase extends EventEmitter {
    ...
    onChannelUnbanRequestResolve(broadcaster, moderator, handler) {
        ...
        return this._genericSubscribe(EventSubChannelUnbanRequestResolveSubscription, handler, this, broadcasterId, moderatorId);
    }
    /**
    ...
    onChannelWarningAcknowledge(broadcaster, moderator, handler) {
        ...
        return this._genericSubscribe(EventSubChannelWarningAcknowledgeSubscription, handler, this, broadcasterId, moderatorId);
    }
    /**
    ...
    onChannelWarningSend(broadcaster, moderator, handler) {
        ...
        return this._genericSubscribe(EventSubChannelWarningSendSubscription, handler, this, broadcasterId, moderatorId);
    }
    /**
    ...
    onChannelSuspiciousUserUpdate(broadcaster, moderator, handler) {
        ...
        return this._genericSubscribe(EventSubChannelSuspiciousUserUpdateSubscription, handler, this, broadcasterId, moderatorId);
    }
    /**
    ...
    onChannelSuspiciousUserMessage(broadcaster, moderator, handler) {
        ...
        return this._genericSubscribe(EventSubChannelSuspiciousUserMessageSubscription, handler, this, broadcasterId, moderatorId);
    }
    /**
    ...
    onAutoModMessageHold(broadcaster, moderator, handler) {
        ...
        return this._genericSubscribe(EventSubAutoModMessageHoldSubscription, handler, this, broadcasterId, moderatorId);
    }
    /**
    ...
    onAutoModMessageUpdate(broadcaster, moderator, handler) {
        ...
        return this._genericSubscribe(EventSubAutoModMessageUpdateSubscription, handler, this, broadcasterId, moderatorId);
    }
    /**
    ...
    onAutoModSettingsUpdate(broadcaster, moderator, handler) {
        ...
        return this._genericSubscribe(EventSubAutoModSettingsUpdateSubscription, handler, this, broadcasterId, moderatorId);
    }
    /**
    ...
    onAutoModTermsUpdate(broadcaster, moderator, handler) {
        ...
        return this._genericSubscribe(EventSubAutoModTermsUpdateSubscription, handler, this, broadcasterId, moderatorId);
    }
    /**
    ...
    onChannelChatUserMessageHold(broadcaster, user, handler) {
        ...
        return this._genericSubscribe(EventSubChannelChatUserMessageHoldSubscription, handler, this, broadcasterId, userId);
    }
    /**
    ...
    onChannelChatUserMessageUpdate(broadcaster, user, handler) {
        ...
        return this._genericSubscribe(EventSubChannelChatUserMessageUpdateSubscription, handler, this, broadcasterId, userId);
    }
    /**

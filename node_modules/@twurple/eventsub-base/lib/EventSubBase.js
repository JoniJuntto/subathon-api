...
let EventSubBase = class EventSubBase extends typed_event_emitter_1.EventEmitter {
    ...
    onChannelWarningAcknowledge(broadcaster, moderator, handler) {
        ...
        return this._genericSubscribe(EventSubChannelWarningAcknowledgeSubscription_1.EventSubChannelWarningAcknowledgeSubscription, handler, this, broadcasterId, moderatorId);
    }
    /**
    ...
    onChannelWarningSend(broadcaster, moderator, handler) {
        ...
        return this._genericSubscribe(EventSubChannelWarningSendSubscription_1.EventSubChannelWarningSendSubscription, handler, this, broadcasterId, moderatorId);
    }
    /**
    ...
    onChannelVipAdd(user, handler) {
        ...
        return this._genericSubscribe(EventSubChannelVipAddSubscription_1.EventSubChannelVipAddSubscription, handler, this, userId);
    }
    /**
    ...
    onChannelVipRemove(user, handler) {
        ...
        return this._genericSubscribe(EventSubChannelVipRemoveSubscription_1.EventSubChannelVipRemoveSubscription, handler, this, userId);
    }
    /**
    ...
    onChannelSuspiciousUserUpdate(broadcaster, moderator, handler) {
        ...
        return this._genericSubscribe(EventSubChannelSuspiciousUserUpdateSubscription_1.EventSubChannelSuspiciousUserUpdateSubscription, handler, this, broadcasterId, moderatorId);
    }
    /**
    ...
    onChannelSuspiciousUserMessage(broadcaster, moderator, handler) {
        ...
        return this._genericSubscribe(EventSubChannelSuspiciousUserMessageSubscription_1.EventSubChannelSuspiciousUserMessageSubscription, handler, this, broadcasterId, moderatorId);
    }
    /**
    ...
    onAutoModMessageHold(broadcaster, moderator, handler) {
        ...
        return this._genericSubscribe(EventSubAutoModMessageHoldSubscription_1.EventSubAutoModMessageHoldSubscription, handler, this, broadcasterId, moderatorId);
    }
    /**
    ...
    onAutoModMessageUpdate(broadcaster, moderator, handler) {
        ...
        return this._genericSubscribe(EventSubAutoModMessageUpdateSubscription_1.EventSubAutoModMessageUpdateSubscription, handler, this, broadcasterId, moderatorId);
    }
    /**
    ...
    onAutoModSettingsUpdate(broadcaster, moderator, handler) {
        ...
        return this._genericSubscribe(EventSubAutoModSettingsUpdateSubscription_1.EventSubAutoModSettingsUpdateSubscription, handler, this, broadcasterId, moderatorId);
    }
    /**
    ...
    onAutoModTermsUpdate(broadcaster, moderator, handler) {
        ...
        return this._genericSubscribe(EventSubAutoModTermsUpdateSubscription_1.EventSubAutoModTermsUpdateSubscription, handler, this, broadcasterId, moderatorId);
    }
    /**
    ...
    onChannelChatUserMessageHold(broadcaster, user, handler) {
        ...
        return this._genericSubscribe(EventSubChannelChatUserMessageHoldSubscription_1.EventSubChannelChatUserMessageHoldSubscription, handler, this, broadcasterId, userId);
    }
    /**
    ...
    onChannelChatUserMessageUpdate(broadcaster, user, handler) {
        ...
        return this._genericSubscribe(EventSubChannelChatUserMessageUpdateSubscription_1.EventSubChannelChatUserMessageUpdateSubscription, handler, this, broadcasterId, userId);
    }
    /**
    ...
    onUserWhisperMessage(user, handler) {
        ...
        return this._genericSubscribe(EventSubUserWhisperMessageSubscription_1.EventSubUserWhisperMessageSubscription, handler, this, userId);
    }
    /** @private */
